  ...
  const majors = [
    {
      ...
      requirements: [
        ...
        "Year One Fall",
        "CMSC 201(Computer Science I), MATH 151, Foreign Langauge 201, ENGL GEP",
        "Year One Spring",
        "CMSC 201(Computer Science II), MATH 152, CMSC 203(Discrete Structures), AH GEP, SS GEP",
        "Year Two Fall",
        "CMSC 331(Principles of Programming Language), CMSC 341(Data Structures), Science Sequence I(see advisor), SS GEP, Elective",
        "Year Two Spring",
        "CMSC 313(Computer Organization & Assembly Language Programming), MATH 221, Science Sequence II(see advisor), Sicence Lab, SS GEP",
        "Year Three Fall",
        "CMSC 304(Social & Ethical Issues in Information Technology, WI), CMSC 411(Computer Architecture), CMSC 4XX Elective, STAT 355",
        "Year Three Spring",
    ...
    },
    {
      ...
      requirements: [
        ...
        "Year One Fall",
        "COMP 101(Computation Thinking & Design), ECON 101, MATH 155, ENGL GEP",
        "Year One Spring",
        "IS 147(Intro. to Computer Programming), MGMT 210, ECON 102, AH GEP, S GEP",
        "Year Two Fall",
        "IS 247(Computer Programming II), IS 300(Management Information Systems), ECON 121, AH GEP, C GEP",
        "Year Two Spring",
        "IS 310(Software and Hardware Concepts), MATH 215, ECON 122, Foreign Language 201, AH GEP",
        "Year Three Fall",
        "IS 410(Intro. to Database Design), IS 450(Data Communications & Networks), S-lab GEP, Elective, Elective",
        "Year Three Spring",
        "IS 420(Database Application Development), IS 451(Design & Management), STAT 351, SS GEP, Upper-level Elective",
        "Year Four Fall",
    ...
    },
    {
      ...
      requirements: [
        "Total credits: 127",
        "Year One Fall",
        "CMSC 201(Computer Science I), MATH 151, PHYS 121, ENGL GEP",
        "Year One Spring",
        "CMSC 201(Computer Science II), MATH 152, CMPE 212(Principles of Digital Design), ENES 101",
        "Year Two Fall",
        "MATH 251, PHYS 122, CMSC 203(Discrete Structures), AH GEP, SS GEP",
        "Year Two Spring",
        "CMPE 306(Basic Circuit Theory), MATH 225, CMPE 310(System Design & Programming), CMSC 341(Data Structures)",
        "Year Three Fall",
        "CMPE 313(Principles of Electronic Circuits), CMPE 311(C Programming & Embedded Systems), MATH 221, Science Elective, AH GEP",
        "Year Three Spring",
    ...
    },
    {
      ...
      requirements: [
        "Total credits: 127",
        "Year One Fall",
        "CHEM 101, MATH 151, ENES 101(Intro. to Engineering), ENGL GEP, AH GEP",
        "Year One Spring",
        "CHEM 102, CHEM 102 Lab, PHYS 121, MATH 152, ENME 110(Statics)",
        "Year Two Fall",
        "ENME 220(Mechanics of Materials), STAT 355, MATH 251, PHYS 122",
        "Year Two Spring",
        "ENME 221(Dynamics), MATH 225, ENME 204(Intro. to Engineering Design with CAD), ENME 217(Engineering Thermodynamics), AH GEP",
        "Year Three Fall",
    ...
    },
    {
      ...
      requirements: [
        ...
        "CHEM 102, CHEM 102 Lab, PHYS 121, MATH 152, ENME 110(Statics)",
        "Year Two Fall",
        "ENCH 251(Chemical Engineering Analysis), CHEM 351, MATH 251, PHYS 122, AH GEP",
        "Year Two Spring",
        "ENCH 225L(Chemical Engineering Problem Solving & Experimental Deign Lab), CHEM 351L, MATH 225, Advanced Science Elective, AH GEP, SS GEP",
        "Year Three Fall",
        "ENCH 300(Chemical Process Thermodynamics), ENCH 425(Transport I: Fluids), CHEM 301, CHEM 331L, Foreign Language 201",
        "Year Three Spring",
        "ENCH 427 (Transport Processes II: Mass Transfer), ENCH 440(Chemical Engineering Kinetics), ENCH 442(Chemical Engineering Systems Analysis), CHEM 302, SS GEP",
        "Year Four Fall",
    ...
    },
    {
      ...
      requirements: [
        "Total credits: 120-121",
        "Year One Fall",
        "IS 125(Info. Systems Logic & Structured Design), ECON 101, MATH 155, ENGL GEP",
        "Year One Spring",
        "IS 202(Systems Analysis Methods), MGMT 210(The Practice of Management), ECON 102, C GEP, AH GEP",
        "Year Two Fall",
        "IS 295(Intermediate Business Applications), ECON 121, S non-lab GEP, AH GEP, Elective",
        "Year Two Spring",
        "IS 300(Management Information Systems), IS 320(Advanced Buisness Applications), ECON 122, Foreign Language 201, C GEP",
        "Year Three Fall",
        "IS 303(Fund. of Human Computer Interaction), MGMT Upper-Level Elective, S w/lab GEP, Elective, Elective",
        "Year Three Spring",
        "IS 325(Intro. to Management Science), STAT 351, SS GEP, Upper-Level Elective, Elective",
        "Year Four Fall",
        "IS 350(Buisness Communications Systems), ENGL 393(WI), IS Upper-Level Elective, AH GEP, Upper-Level Elective",
        "Year Four Spring",
    ...
    <Container>
      <Stack p={2}>
        <Stack width={{ sm: "100%", lg: "60%" }}>
          ...
          and a bachelor of arts in buisness tecnology administration. Computer science, computer science, and chemical engineering each have different tracks a
            ...
            {majors.map((major) => (
              <Stack key={major.id} spacing={3}>
                ...
                {activeMajor === major.id && (
                    <Stack ml={8} spacing={3} pb={6} borderLeft="4px solid" borderColor="gray.300" pl={4}>
